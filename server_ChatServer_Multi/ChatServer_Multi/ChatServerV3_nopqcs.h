#ifndef __CHAT_SERVER_NO_PQCS_H__
#define __CHAT_SERVER_NO_PQCS_H__
#include "NetServer.h"
...
constexpr int WAIT_LOGIN_TIME = 10000;
constexpr int WAIT_HEARTBEAT_TIME = 10000;
