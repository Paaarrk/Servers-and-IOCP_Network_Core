#ifndef __ZONE_SESSION_H__
#define __ZONE_SESSION_H__
#include "NetBase.h"
...
namespace Net
{
	...
	struct stZoneSession
	{
		...
		//Core::CLockFreeQueue<Net::stEvent*> recvedPackets;
		Core::RingBuffer					recvedPackets;
		wchar_t								ip[16];
		stZoneSession();
		~stZoneSession();
		//-------------------------------------------------------
		...
		// 
		// // FOR ZONE
		// bool IsNeedReleasedByZone() const
		// {
		// 	return (refcount == 1);
		// }
		// 
